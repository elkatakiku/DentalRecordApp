...
public class AppointmentFormViewModel extends ViewModel implements TextChange {
    ...
    public AppointmentFormViewModel() {
        ...
        this.mPatients = new MutableLiveData<>();
        ...
        this.patientsListener = new PatientRepository.PatientsListener(mPatients);
    ...
    public void setmUid(String patientUid) {
        mUid.setValue(patientUid);
    }
    ...
    public void loadPatient(String patientUid) {
        PatientRepository
                .getInstance()
                .getPath(patientUid)
                .addListenerForSingleValueEvent(patientListener);
    }
    ...
    public LiveData<List<Person>> getmPatients() {
        return mPatients;
    }
    ...
    public void createAppointment(String firstname,
        ...
        Person person = new Person(
                ...
                middleInitial,
                suffix,
                ContactNumber.createList(contact)
        );
