package com.bsit_three_c.dentalrecordapp.ui.patients.procedure_form.ui.procedureform;
...
//    };
    ...
    public Intent createResultIntent(
        ...
        return new Intent()
                .putExtra(LocalStorage.PROCEDURE_KEY, procedure)
                .putExtra(LocalStorage.PROGRESS_NOTE_KEY, progressNote);
    }
